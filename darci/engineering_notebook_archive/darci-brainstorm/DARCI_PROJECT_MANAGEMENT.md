...
{
  "id": "T001",
  "title": "Fix import paths in darci-go",
  "description": "Update imports from darci-go/darci/* to darci-go/internal/*",
  "priority": "P0",
  "status": "completed",
  "created_at": "2026-03-07T10:00:00Z",
  "updated_at": "2026-03-07T11:30:00Z",
  "dependencies": [],
  "labels": ["build", "darci-go", "bugfix"],
  "artifacts": {
