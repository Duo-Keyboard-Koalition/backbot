...
Implement long polling support in darci-go Telegram channel to achieve feature parity with Python implementation.
...
**Task:** Fix darci-go build errors

---

## Objective

Resolve import path errors preventing darci-go build.
