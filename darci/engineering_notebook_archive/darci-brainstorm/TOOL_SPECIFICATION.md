...
```json
{
  ...
  "arguments": {
    ...
    "priority": "P0",
    "labels": ["telegram", "darci-go", "feature"],
    "dependencies": ["T001"]
  }
}
```
...
name: build_run
parameters:
  target: enum [darci-go, darci-python, all] (required)
...
name: config_read
parameters:
  config_type: enum [darci, darci, custom] (required)
...
```yaml
# ~/.darci/darci/skills/project_manager/SKILL.md
---
