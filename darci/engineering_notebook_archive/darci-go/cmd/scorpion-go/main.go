...
func main() {
	workspace := envOr("DARCI_GO_WORKSPACE", ".")
	...
	agent := adk.NewAgent(
		adk.RuleModel{},
		tools,
		"You are DarCI-Go ADK. A capable AI assistant with file system, shell, and web access. "+
	...
	fmt.Printf("🐈 darci-go adk ready (workspace=%s)\n", base)
