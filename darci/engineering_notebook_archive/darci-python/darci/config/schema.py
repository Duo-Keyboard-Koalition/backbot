...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.darci-python/workspace"
...
class ProviderConfig(Base):
    ...
    voice_id: str = ""  # Used by ElevenLabs for TTS voice selection


class ProvidersConfig(Base):
    """Configuration for providers (DarCI: Gemini-only core)."""
...
class Config(BaseSettings):
    ...
    def _match_provider(self, model: str | None = None) -> tuple["ProviderConfig | None", str | None]:
        """Match provider config. DarCI uses Gemini exclusively."""
    ...
    model_config = ConfigDict(env_prefix="DARCI_", env_nested_delimiter="__")
