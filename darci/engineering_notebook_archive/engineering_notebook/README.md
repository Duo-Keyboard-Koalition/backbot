...
This engineering notebook serves as the **single source of truth** for all development work on the DarCI project by Qwen Code agents.
...
|-----------|---------|----------------|
| `python/` | Python implementation (`darci-python/`) | TUI tests, channel implementations, provider updates |
| `go/` | Go implementation (`darci-go/`) | Compilation fixes, ADK integration, tool implementations |
...
- [TUI Agent Test Results](python/2026-03-07_tui_agent_test_results.md) - Testing Python agent with `~/.darci-python/` config
...
| Document | Purpose |
|----------|---------|
| `../darci-python/README.md` | Python implementation docs |
| `../darci-go/README.md` | Go implementation docs |
