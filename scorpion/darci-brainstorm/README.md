...
Built on the [Scorpion](../scorpion-python/) framework - ultra-lightweight personal AI assistant.
...
```bash
mkdir -p ~/.scorpion/darci/{memory,notebooks,metrics,artifacts}
```
...
# CLI command
scorpion agent -m "Create tasks for implementing Telegram webhook support"
```
...
**User:** "Build scorpion-go and fix any errors"

**DarCI:**
```
🔧 Building scorpion-go...
...
- [Scorpion Python](../scorpion-python/) - Main Python implementation
- [Scorpion Go](../scorpion-go/) - Go implementation
- [Scorpion README](../scorpion-python/README.md) - Framework documentation
...
3. Test with Scorpion framework
...
| CLI | Direct interaction | `scorpion agent` |
...
Same as Scorpion project - MIT License
