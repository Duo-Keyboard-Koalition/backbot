...
With ADK, the system prompt is used as the LlmAgent instruction.
Message assembly, tool results, and assistant messages are handled by ADK internally.
"""
...
class ContextBuilder:
    """Builds the system prompt (ADK instruction) for the agent."""
...
You are scorpion, a helpful AI assistant.
