...
from darci.config.schema import EmailConfig
...
class EmailChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "scorpion reply")
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "scorpion reply"
