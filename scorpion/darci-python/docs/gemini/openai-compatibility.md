...
> **Status: Not applicable** — darci uses native google-genai SDK
...
**Note:** The OpenAI compatibility layer is useful for migrating existing OpenAI codebases. Since darci was built Gemini-native, there's no need for this.
