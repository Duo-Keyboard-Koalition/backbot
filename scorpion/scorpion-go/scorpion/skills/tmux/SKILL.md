...
Terminal multiplexer integration for the scorpion agent.

## Description

This skill enables the scorpion agent to interact with tmux sessions for terminal management and long-running processes.
