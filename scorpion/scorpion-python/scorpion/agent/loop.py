...
from scorpion.agent.tools.spawn import SpawnTool
from scorpion.agent.tools.web import WebFetchTool, WebSearchTool
...
class AdkAgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from scorpion.agent.tools.mcp import connect_mcp_servers
        try:
